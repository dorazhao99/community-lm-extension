...
const RequestVariables = {
  promptHeader: `
    ...
    2. If the knowledge is NOT relevant, disregard the knowledge. Do NOT make reference to it, and answer the query. Ignore knowledge that is irrelevant.\n
    3. Do NOT search the web if there is enough provided knowledge to answer the query.\n
    4. Check whether there are conflicts in the knowledge. Report conflicts in the output if they exist.
    \nKnowledge:<cllm>`,
}
